...
class MyProjectsPage extends StatefulWidget {
  ...
  const MyProjectsPage({Key key, this.client}) : super(key: key);
  @override
...
class _MyProjectsPageState extends State<MyProjectsPage> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        if (meta.nextPage != null) {
          ...
          getMyProjects(meta.nextPage, httpClient: widget.client)
    ...
    getMyProjects(1, httpClient: widget.client).then((projectsResponse) {
      projectsResponse.data.forEach((data) {
        dataList.add(data);
      });
      setState(() {
